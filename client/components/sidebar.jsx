      ...
      <div className="mt-16 pt-5">
        <div className="container">
          ...
          <div className="grid mt-5">
            <Link to="/" className={`flex items-center gap-5 py-2.5 px-5 rounded-r-3xl ${page === '/' && 'bg-gray-100'}`}>
              <icon.BiHomeSmile className="text-2xl" />
              <p className="text-base">My Storage</p>
            </Link>
            <Link to="/trash" className={`flex items-center gap-5 py-2.5 px-5 rounded-r-3xl ${page === '/trash' && 'bg-gray-100'}`}>
