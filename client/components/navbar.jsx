...
function Navbar() {
  ...
  return (
    <div className="absolute w-full h-16 border border-gray-300 border-solid border-x-0 border-t-0 bg-white z-10">
      {
      ...
      <div className="w-full py-2 px-5 grid grid-cols-3/auto-1fr-0.5fr items-center">
        ...
        <label htmlFor="search" className="flex items-center gap-3.5 w-full bg-gray-100 py-1.5 pl-3.5 pr-1.5 rounded-lg">
